...
module mAdcOW.Search.VariableInjection {
    ...
    function loadUserVariables() {
        ...
        SP.SOD.executeFunc('sp.js', 'SP.ClientContext', () => {
            ...
            var urlCurrentUser : string = _spPageContextInfo.siteAbsoluteUrl + "/_vti_bin/listdata.svc/UserInformationList?$filter=Id eq " + _spPageContextInfo.userId;

            jQuery.getJSON(urlCurrentUser).done(data => {
